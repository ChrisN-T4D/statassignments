...
export const statisticsExercises = [
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, find where to add a new computed variable',
    instructions: 'Using bmi_and_exercise.csv from Tools, find where in Jamovi to add a new computed variable (e.g. for a transformation of BMI or exercise).',
    software_type: 'jamovi',
    exercise_type: 'menu_navigation',
    ...
    success_message: 'Correct! Data > Add > Computed Variable lets you create new variables. For one column use VMEAN, VSTDEV, VSUM; for several variables per row use MEAN(A,B,C) or SUM(A,B,C).',
    order: 24,
    is_active: true
  },
  {
  ...
  },
  {
    ...
    phase: 'practice',
    description: 'Using bmi_and_exercise.csv from Tools, create a computed variable (e.g. BMI minus mean)',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a computed variable that centers BMI: bmi − VMEAN(bmi). Match lowercase column names from Tools. VMEAN = mean of one column; MEAN(A, B, C) = mean of several variables per row.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    phase: 'practice',
    description: 'Using bmi_and_exercise.csv from Tools, recode BMI into three categories (e.g. Underweight/Normal/Overweight)',
    instructions: 'Using bmi_and_exercise.csv from Tools, use Data > Transform (Add recode condition) to recode BMI into three categories. Use standard cut points (e.g. under 18.5, 18.5 to 25, 25+) or Low/Normal/High.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    phase: 'apply',
    description: 'Using bmi_and_exercise.csv from Tools, create a filter and compare Descriptives with filter ON and OFF',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a filter (e.g. BMI >= 25, or exercise > 0). Run Descriptives for BMI with the filter ON and OFF and compare how N, mean, and SD change.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  // Apply uses the personality dataset (Learn used BMI).
  {
    ...
    instructions: 'Open personality_data.csv from Tools (Extraversion, Agreeableness, etc.). Create a computed variable that calculates how far each person\'s Extraversion score deviates from the mean: extraversion − VMEAN(extraversion) (match casing in the Tools file).',
    software_type: 'jamovi',
    exercise_type: 'menu_navigation',
    hint: 'Data > Add > Computed Variable. Formula: extraversion − VMEAN(extraversion) (match casing in the Tools file). Use your variable name if different (case-sensitive).',
    expected_selections: [
      { menu: 'data', option: 'add-variable', subOption: 'computed' }
    ],
    sample_data: {
  ...
  },
  {
    ...
    instructions: 'Using personality_data.csv from Tools, convert Extraversion (or another scale variable) to z-scores. Find how to create z-scores in Jamovi (Exploration > Descriptives).',
    software_type: 'jamovi',
    exercise_type: 'menu_navigation',
  ...
  },
  {
    ...
    instructions: 'Using personality_data.csv from Tools, check whether Extraversion (or Neuroticism) is normally distributed. Find the Shapiro-Wilk normality test in Jamovi (Exploration > Descriptives > Statistics).',
    software_type: 'jamovi',
    exercise_type: 'menu_navigation',
  ...
  },
  {
    ...
    instructions: 'Using personality_data.csv from Tools, run Exploration > Descriptives for Extraversion (or Agreeableness). Write a short summary of mean, median, SD, and min/max.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    instructions: 'Using personality_data.csv from Tools, run Descriptives for Extraversion (or Agreeableness) and use Split by with a grouping variable (e.g. gender, or a recoded category). Identify which group has higher center and larger spread.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    instructions: 'Using personality_data.csv from Tools, create a z-score version of Extraversion (via Descriptives or Compute). Identify any cases with |z| >= 2 (or your chosen cutoff).',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    instructions: 'Using personality_data.csv from Tools, run Descriptives for Extraversion (or another scale). Use skewness and kurtosis (and an optional plot) to assess whether the distribution is skewed or has outliers. Justify when reporting median and IQR would be more appropriate than mean and SD.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, create a bar chart for a categorical variable',
    instructions: 'Using bmi_and_exercise.csv from Tools, first Transform/Compute a BMI category from bmi (e.g. under 25 vs 25+), then create a bar chart for that categorical variable. Find the appropriate menu.',
    software_type: 'jamovi',
    exercise_type: 'menu_navigation',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, compare BMI across groups with a boxplot',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a boxplot for bmi. Optionally Split by a BMI category you create with Transform; otherwise boxplot bmi alone.',
    software_type: 'jamovi',
    exercise_type: 'menu_navigation',
  ...
  // ============ MODULE 5: Data Manipulation (Chapter 6) ============
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, create a frequency table for a categorical variable',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a frequency table for a BMI category variable you create with Transform (bmi has no gender column). Use Descriptives and check "Frequency tables".',
    software_type: 'jamovi',
    exercise_type: 'menu_navigation',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, create a category with logical expressions',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a computed variable or use Transform with a logical expression to categorize BMI (e.g. BMI >= 25 → "Overweight", else "Not overweight").',
    software_type: 'jamovi',
    exercise_type: 'menu_navigation',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, create a centered variable',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a computed variable that centers BMI around its mean: BMI - VMEAN(BMI). Optionally do the same for exercise hours.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, use ABS() for distance from mean',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a variable for absolute deviation from mean BMI: ABS(BMI - VMEAN(BMI)). This measures how far each person is from the average, regardless of direction.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, recode a continuous variable into categories',
    instructions: 'Using bmi_and_exercise.csv from Tools, recode exercise hours (or BMI if you prefer) into 3 categories (e.g. Low/Medium/High) using Data > Transform with Add recode condition or nested IF.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, create a Transform that can be applied to multiple variables',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a transformation in Data > Transform (e.g. center with $source - VMEAN($source)) that can be applied to both BMI and exercise. Apply it to at least two variables.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, create BMI categories with Transform Add Condition',
    instructions: 'Using bmi_and_exercise.csv from Tools, use Data > Transform with Add recode condition to create BMI categories (e.g. if $source < 18.5 use "Underweight", if $source < 25 use "Normal", else use "Overweight").',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, filter cases and run Descriptives',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a filter (e.g. BMI >= 25, or exercise > 0) and run Descriptives for BMI with the filter on. Compare to when the filter is off.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    description: 'Using bmi_and_exercise.csv from Tools, apply a mathematical function (e.g. LOG, SQRT)',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a computed variable using a mathematical function (e.g. LOG(BMI), SQRT(BMI), or LN(BMI)) and write 2-3 sentences on when such a transformation is useful (e.g. for skewed distributions).',
    software_type: 'jamovi',
    exercise_type: 'instructional',
  ...
  },
  {
    ...
    phase: 'apply',
    description: 'Using bmi_and_exercise.csv from Tools, create a filter with AND/OR',
    instructions: 'Using bmi_and_exercise.csv from Tools, create a filter using AND and/or OR (e.g. BMI >= 25 and exercise < 2, or BMI < 18.5). Run Descriptives with the filter on and briefly explain who is included.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
