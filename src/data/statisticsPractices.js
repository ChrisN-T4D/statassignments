...
export const statisticsExercises = [
  ...
  },
  {
    ...
    instructions: 'Using your BMI dataset, create a computed variable that centers BMI: BMI - VMEAN(BMI). VMEAN = mean of one column; MEAN(A, B, C) = mean of several variables per row.',
    software_type: 'jamovi',
    exercise_type: 'instructional',
