...
export const topicsMeta = [
  ...
  },
  {
    ...
    "description": "Methods of knowing, scientific goals, and common sense vs science.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-2",
    ...
    "description": "Finding topics, hypotheses, design, analysis, and reporting.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-3",
    ...
    "description": "Ethical principles, codes, and practical conduct of research.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-4",
    ...
    "description": "Measurement levels, reliability, validity, and implementation strategies.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-5",
  ...
  },
  {
    ...
    "description": "Survey construction, administration, and quality considerations.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-8",
    ...
    "description": "One-group and non-equivalent groups design strategies.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-9",
  ...
  },
  {
    ...
    "description": "Overview, design variants, and interpretation in single-subject methods.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-11",
    ...
    "description": "APA style and other presentation formats for research.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-12",
    ...
    "description": "Describing variables, relationships, and expressing results.",
    "icon": "T"
  },
  {
    "id": "rm-chapter-13",
    ...
    "description": "Null hypothesis testing, basic tests, and replicability issues.",
    "icon": "T"
  }
]
