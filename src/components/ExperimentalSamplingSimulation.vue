<template>
  <div class="exp-sim">
    ...
    <p v-else-if="embedTab === 'sampling'" class="exp-sim-lead exp-sim-lead-compact">
      Sampling mini-lab below — compare plans and watch how <strong>x̄</strong> tracks <strong>μ</strong>.
    </p>
    ...
    >
    <SamplingCompareLab :intro="embedTab === 'sampling' ? 'rm-embed' : 'rm'" />
    </div>
...
import SamplingCompareLab from './sampling/SamplingCompareLab.vue'
